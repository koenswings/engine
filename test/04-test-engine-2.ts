...
describe('Test engine 2 - ', () => {
    ...
    before(async function () {
        ...
        connection2Promise = connectEngine(network2, testEngine2Address)
    ...
    it(`the data for the remote engine must have the right properties`, async function () {
        ...
        expect(remoteEngine.connectedInterfaces[testInterface].ip4).to.eql(findIp(testEngine2Address))
